 ...
 * service is started.
 */
public abstract class JobHeadlessJsTask extends JobIntentService implements HeadlessJsTaskEventListener {

    private static final String TAG = JobHeadlessJsTask.class.getSimpleName();
    ...
    public void onHandleWork(Intent intent) {
        Log.d(TAG, "Handle headless work");
    ...
    public void onHeadlessJsTaskFinish(int taskId) {
        Log.d(TAG, "Headless task finished");
